...
if Status or Dev_GRiNd(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if hash or Dev_GRiNd(msg) or DeveloperBot(msg) or Bot(msg) then  
return true 
else 
return false 
end 
...
if hash or Dev_GRiNd(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_GRiNd(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_GRiNd(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_GRiNd(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Admin(msg) or Bot(msg) then     
return true 
else 
return false 
end 
...
send(chat,msg.id_," .𖣂 الملف لا يتوافق مع البوت يرجى رفع ملف نسخة الكروبات الحقيقي")   
return false 
end      
...
send(msg.chat_id_, msg.id_, "\n .𖣂 لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(userid,msg.chat_id_).."")
else
...
Send_Options(msg,userid,"reply"," .𖣂 تم تقييده في المجموعه")  
end
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 .𖣂 ارسل { م1 } ← اوامر الحمايه
 .𖣂 ارسل { م2 } ← اوامر الادمنيه
 .𖣂 ارسل { م3 } ← اوامر المدراء
